...
import { Send, CircleSlash } from "lucide-react";

export default function PayslipApprovalCard() {
  return (
    <div className="w-[445px] h-[315px] bg-white rounded-2xl p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-[#282C30] rounded-full">
          ...
          <span className="text-[12px] font-bold text-white">See All Data</span>
        </button>
      </div>
          ...
          >
            ...
            <div className="w-[80px] flex justify-center">
              <span className="px-2 py-[2px] text-[8px] text-white bg-[#FF684D] rounded-full">
                <CircleSlash size={12} className="inline-block mr-1" />
                Canceled
              </span>
            </div>
          </div>
